...
static void CAN_Filter_Config(void)
{
   CAN_FilterInitTypeDef CAN_FilterInitStructure;
	 ...
	 CAN_FilterInitStructure.CAN_FilterIdHigh = (((uint32_t)0x1800<<3) & 0XFFFF0000) >> 16;    //要过滤的ID高位
	 CAN_FilterInitStructure.CAN_FilterIdLow = (((uint32_t)0x1800<<3) | CAN_ID_EXT | CAN_RTR_DATA) & 0XFFFF;    //要过滤的地位
